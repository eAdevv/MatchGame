...
public class PoolManager : MonoSingleton<PoolManager>
{
    ...
    {
		EventManager.OnPoolSpawn += CreatePool;
		EventManager.OnGetPoolObject += GetObject;
		EventManager.OnPoolClear += ClearPool;
    }
	...
	public void ClearPool() // Editlenicek Test
    {
		poolParents.Clear();
		poolPrefabs.Clear();
		poolUsedDictionary.Clear();
		poolFreeDictionary.Clear();
		Destroy(poolParent);
    }
